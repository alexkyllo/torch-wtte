...
def test_log_likelihood_discrete():
    ...
    loss_values = loss.log_likelihood_discrete(tte, uncensored, alpha, beta)
...
def test_log_likelihood_continuous():
    ...
    loss_values = loss.log_likelihood_continuous(tte, uncensored, alpha, beta)
    # results from wtte-rnn package
    expected = torch.tensor(
        [
